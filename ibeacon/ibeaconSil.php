...
$sil=$db->prepare("DELETE from ibeaconlar where ID=:ID");
...
if ($kontrol) {
		...
		<meta http-equiv="refresh" content="0.0;url=ibeaconListele.php?durum=ok"><?php
			exit; //her header'dan sonra sonlandırma için exit kullanmak yararlıdır.
		}
		else{
			 ?>
		<script> alert("SİLME İŞLEMİ BAŞARISIZ");</script> 
		<meta http-equiv="refresh" content="0.0;url=ibeaconListele.php?durum=no"><?php
			exit;
		}
